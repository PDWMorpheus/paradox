...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand characterCommandTable[] =
    {
        ...
        { "setstanding",    SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleModifyRepCommand>,              "", NULL },
    ...
    static ChatCommand cheatCommandTable[] =
    {
        ...
        { "taxi",           SEC_MODERATOR,      false,  OldHandler<&ChatHandler::HandleTaxiCheatCommand>,        "", NULL },
    ...
    static ChatCommand lookupCommandTable[] =
    {
		...
		{ "displayid",       SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleLookupCreatureDisplayCommand>,      "", NULL },
    ...
    static ChatCommand serverDisableCommandTable[] =
    {
        {"spell",         SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleDisableSpellCommand>,           "", NULL },
        {"displayid",     SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleDisableDisplayCommand>,         "", NULL },
        {"npc",           SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleDisableNPCCommand>,            "", NULL },
        {"item",          SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleDisableItemCommand>,            "", NULL },
        {"gobject",       SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleDisableObjectCommand>,          "", NULL },
        {"zone",          SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleDisableZoneCommand>,            "", NULL },
        { NULL,           0,                   false, NULL,                                                          "", NULL }
    };

    static ChatCommand serverEnableCommandTable[] =
    {
        {"spell",         SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleEnableSpellCommand>,            "", NULL },
        {"displayid",     SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleEnableDisplayCommand>,          "", NULL },
        {"npc",           SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleEnableNPCCommand>,            "", NULL },
        {"item",          SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleEnableItemCommand>,             "", NULL },
        {"gobject",       SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleEnableObjectCommand>,           "", NULL },
        {"zone",          SEC_ADMINISTRATOR,   true,  OldHandler<&ChatHandler::HandleEnableZoneCommand>,              "", NULL },
        { NULL,           0,                   false, NULL,                                                          "", NULL }
    };
    ...
    static ChatCommand serverCommandTable[] =
    {
        ...
        { "disable",        SEC_ADMINISTRATOR,  true,  NULL,       "", serverDisableCommandTable                            },
        { "enable",         SEC_ADMINISTRATOR,  true,  NULL,                                   "", serverEnableCommandTable },
        { NULL,             0,                  false, NULL,                                                       "", NULL }
    };
    ...
    {
        { "appear",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleToggleAppearCommand>,       "", NULL },
        { "modify",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleToggleModifyCommand>,       "", NULL },
        { "summon",         SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleToggleSummonCommand>,       "", NULL },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "cheat",          SEC_GAMEMASTER,     true,  NULL,                                           "", cheatCommandTable    },
        { "guild",          SEC_ADMINISTRATOR,  true,  NULL,                                           "", guildCommandTable    },
        { "instance",       SEC_ADMINISTRATOR,  true,  NULL,                                           "", instanceCommandTable },
        { "toggle",         SEC_GAMEMASTER,     true,  NULL,                                           "", toggleCommandTable   },
        { "list",           SEC_ADMINISTRATOR,  true,  NULL,                                           "", listCommandTable     },
        { "lookup",         SEC_ADMINISTRATOR,  true,  NULL,                                           "", lookupCommandTable   },
        { "pet",            SEC_GAMEMASTER,     false, NULL,                                           "", petCommandTable      },
        { "nudge",          SEC_GAMEMASTER,     true,  NULL,                                           "", nudgeCommandTable    },
        ...
        { "gayporn",		SEC_PLAYER,			false,	OldHandler<&ChatHandler::HandleGayPornCommand>,			   "", NULL },
        ...
        { "moveitem",       SEC_GAMEMASTER,     false, OldHandler<&ChatHandler::HandleItemMoveCommand>,            "", NULL },
        ...
        { "worldport",      SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleGoXYZCommand>,               "", NULL },
        { "mount",          SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleMountCommand>,               "", NULL },
        { "colors",         SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::TestColors>,                       "", NULL },
		{ "setanncolor",    SEC_GAMEMASTER,    true,  OldHandler<&ChatHandler::HandleModifyAnnounceColorCommand>, "", NULL },
...
void ChatHandler::RedSystemMessageToPlr(Player* player, const char *message, ...)
{
	WorldPacket data;
...
void ChatHandler::GreenSystemMessageToPlr(Player* player, const char *message, ...)
{
	WorldPacket data;
...
void ChatHandler::BlueSystemMessageToPlr(Player* player, const char *message, ...)
{
	WorldPacket data;
