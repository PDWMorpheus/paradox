...
class ChatHandler
{
    public:
		...
		//virtual void SendSysMessageToPlr(Player* player, const char *str);

        void SendSysMessage(int32     entry);
        void PSendSysMessage(const char *format, ...) ATTR_PRINTF(2, 3);
        void PSendSysMessage(int32     entry, ...);
        //void PSendSysMessageToPlr(Player* player, const char *format, ...) ATTR_PRINTF(2, 3);
        //void PSendSysMessageToPlr(Player* player, int32     entry, ...);
    ...
    protected:
        ...
        bool TestColors(const char* args);
		...
		bool HandleLookupCreatureDisplayCommand(const char* args);
        ...
        bool HandleDisableDisplayCommand(const char* args);
        bool HandleDisableItemCommand(const char* args);
        bool HandleDisableObjectCommand(const char* args);
        bool HandleDisableZoneCommand(const char* args);
        bool HandleDisableNPCCommand(const char* args);

        bool HandleEnableSpellCommand(const char* args);
        bool HandleEnableDisplayCommand(const char* args);
        bool HandleEnableItemCommand(const char* args);
        bool HandleEnableObjectCommand(const char* args);
        bool HandleEnableZoneCommand(const char* args);
        bool HandleEnableNPCCommand(const char* args);
        ...
        //bool HandleServerDisableCommand(const char* args);
        //bool HandleServerEnableCommand(const char* args);
        ...
        bool HandleToggleModifyCommand(const char* args);
        ...
        bool HandleModifyAnnounceColorCommand(const char* args);
