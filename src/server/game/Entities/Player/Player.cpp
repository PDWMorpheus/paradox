...
uint32 Player::GetSelectedGobject()
{
    return m_selectedGobject;
}

void Player::SetSelectedGobject(uint32 gobId)
{
    m_selectedGobject = gobId;
}
...
bool m_cheatGod = false;
bool m_cheatCastTime = false;
bool m_cheatCoolDown = false;
bool m_cheatFly = false;
bool m_cheatPower = false;
bool m_cheatWaterWalk = false;
bool m_cheatTriggerPass = false;
bool m_toggleAppear = false;
bool m_toggleSummon = false;
bool m_toggleModify = false;
uint32 m_lastSpawnTime = 0;

uint32 m_selectedGobject = 0;
std::string m_annColor = "|cffffff00";

void Player::ToggleCommand(int command)
{
    switch (command)
    {
    case CHEAT_GOD: m_cheatGod = !m_cheatGod;
        break;
    case CHEAT_CASTTIME: m_cheatCastTime = !m_cheatCastTime;
        break;
    case CHEAT_COOLDOWN: m_cheatCoolDown = !m_cheatCoolDown;
        break;
    case CHEAT_FLY: m_cheatFly = !m_cheatFly;
        break;
    case CHEAT_POWER: m_cheatPower = !m_cheatPower;
        break;
    case CHEAT_WATERWALK: m_cheatWaterWalk = !m_cheatWaterWalk;
        break;
    case CHEAT_TRIGGERPASS: m_cheatTriggerPass = !m_cheatTriggerPass;
        break;
    case TOGGLE_APPEAR: m_toggleAppear = !m_toggleAppear;
        break;
    case TOGGLE_SUMMON: m_toggleSummon = !m_toggleSummon;
        break;
    case TOGGLE_MODIFY: m_toggleModify = !m_toggleModify;
        break;
    default: 
        break;
    }
...
void Player::SetAnnounceColor(std::string color)
{
    m_annColor = color;
}

std::string Player::GetAnnounceColor()
{
	return m_annColor.c_str();
}
